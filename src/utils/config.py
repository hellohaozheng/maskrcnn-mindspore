...
def parse_args():
    ...
    # MaskRcnn evaluation
    parser.add_argument('--ann_file', default='./cocodataset/annotations/instances_val2017.json',
    ...
    parser.add_argument('--img_path', default='./cocodataset/val2017',
                        type=str, help="File path of dataset in inference.")
    parser.add_argument('--ann_path', default='./cocodataset/annotations/instances_val2017.json',
