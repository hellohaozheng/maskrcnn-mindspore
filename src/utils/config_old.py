...
config = ed({
    ...
    # Dataset path
    "data_root": "/home/maskrcnn/cocodataset",
    ...
    "do_eval": False,
    "dataset": "coco",
    "pre_trained": "./checkpoint/maskrcnn_coco2017_acc32.9.ckpt",
    "device_id": 0,
    "device_num": 1,
    "rank_id": 0,

    # MaskRcnn evaluation
    "ann_file": "/home/maskrcnn/cocodataset/annotations/instances_val2017.json",
    "checkpoint_path": './checkpoint/maskrcnn_ascend_v170_coco2017_official_cv_acc32.9.ckpt',

    # MaskRcnn ResNet50 export"
    "batch_size_export": 1,
    "ckpt_file": '/home/maskrcnn/cocodataset/checkpoint/maskrcnn_gpu_coco.ckpt',
    "file_name": "maskrcnn_mobilenetv1",
    "file_format": "MINDIR",

    # MaskRcnn ResNet50 inference
    "img_path": '/home/maskrcnn/cocodataset/val2017',
    "ann_path": '/home/maskrcnn/cocodataset/annotations/instances_val2017.json',
    "result_path": './images',
    ...
    "mindrecord_dir": "/home/maskrcnn/cocodataset/MindRecord_COCO",
    "train_data_type": "train2017",
    "val_data_type": "val2017",
    "instance_set": "annotations/instances_{}.json",
    "data_classes": ('background', 'person', 'bicycle', 'car', 'motorcycle', 'airplane', 'bus',
